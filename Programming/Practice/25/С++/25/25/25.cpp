...
vector<int> BozoSort(vector<int> array, bool sorting = true)
{
...
vector<int> BozoSort(vector<vector<int>> array2D, bool sorting = true)
{
...
vector<int> BozoSort(int a, int b, int c, bool sorting = true)
{
